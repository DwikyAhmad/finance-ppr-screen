...
export default function LeftRightPartPage() {
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Left Right Part Master</h1>
          </div>
        </div>
            ...
            <div>
              ...
              <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Left Right Part">Left Right Part</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-blue-600 hover:bg-blue-600">
                ...
                <TableHead className="text-white font-semibold">ValueText</TableHead>
                <TableHead className="text-white font-semibold">ValueNumber</TableHead>
                <TableHead className="text-white font-semibold">createdAt</TableHead>
                <TableHead className="text-white font-semibold">updatedAt</TableHead>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="sm:max-w-[525px]">
            <DialogHeader>
              <DialogTitle>
                {editingItem ? "Edit" : "Create"} Left Right Part
              </DialogTitle>
              <DialogDescription>
                {editingItem ? "Update" : "Add new"} left right part data. Click save when you&apos;re done.
              </DialogDescription>
            </DialogHeader>
